...
export const Foot = () => {
    ...
    return (
        ...
        <Box display={'flex'} justifyContent={'space-around'} pt={5} pb={2} bgcolor={'white'}>
            <Email />
            ...
            <Stack direction={'column'} display={'flex'} mt={0.5}>
                ...
                <Typography mt={0.1} mb={1} letterSpacing={1.5} sx={{ cursor: 'pointer' }} fontFamily={"Montserrat"}>About</Typography>
